        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
            ...
            <motion.div 
              ...
              className="mx-auto aspect-video overflow-hidden rounded-xl object-cover object-center sm:w-full lg:order-last border shadow-2xl"
            >
              <img
                alt="Network Visualization"
                className="h-full w-full object-cover"
                src="https://images.unsplash.com/photo-1762279389006-43963a0cee55?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxuZXR3b3JrJTIwZGF0YSUyMHZpc3VhbGl6YXRpb24lMjBhYnN0cmFjdCUyMGRhcmslMjBibHVlfGVufDF8fHx8MTc3MTAyMjkyM3ww&ixlib=rb-4.1.0&q=80&w=1080"
              />
            </motion.div>
          </div>
        </div>
